    ...
    public class NLogger : ITraceWriter
    {
        ...
        public void Trace(HttpRequestMessage request, string category, TraceLevel level, Action<TraceRecord> traceAction)
        {
            if (level != TraceLevel.Off)
            {
                ...
                {
                    category = category + Environment.NewLine + "Action Paremeters : " + traceAction.Target;
                }
        ...
        private void Log(TraceRecord record)
        {
            ...
            if (record.Request != null)
            {
                ...
                if (record.Request.RequestUri != null)
                    message.Append("URL: " + record.Request.RequestUri + Environment.NewLine);

                if (record.Request.Headers != null && record.Request.Headers.Contains("Token") &&
                    record.Request.Headers.GetValues("Token") != null && record.Request.Headers.GetValues("Token").FirstOrDefault() != null)
